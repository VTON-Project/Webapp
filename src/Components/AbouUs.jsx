...
function Home() {
  return (
    <div style={{ margin: "0 10%", padding: "5% 0", backgroundColor: "" }}>
      <Card sx={{ maxWidth: 1200, backgroundColor: "#B0E0E6" }}>
        <CardContent>
          ...
          <Typography variant="body1">
            The evolution of Virtual Try-On (VTON) technology has been a
            ...
            works we have leveraged: 1. General Purpose Virtual Try-On Network
            ...
            learning, is aimed at broadening the scope and applicability of VTON
            systems. This work shines a light on the pathway towards achieving a
            versatile VTON system that can cater to a diverse range of apparel
